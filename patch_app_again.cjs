...
const prefixIdx = appCode.indexOf('{showMap && (');
const suffixIdx = appCode.indexOf('{loading && !isAutoBattling && (');
...
if (prefixIdx > -1 && suffixIdx > -1) {
  ...
  appCode = appCode.substring(0, prefixIdx) + newMapContent + appCode.substring(suffixIdx);
